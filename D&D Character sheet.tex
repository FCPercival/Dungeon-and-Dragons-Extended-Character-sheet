...
% --- Features and Pitches Box ---
        \begin{tcolorbox}[dndboxgray,
            ...
            \noindent\begin{tabular}{c|l|c|c}
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{ST_Strength}{0.6cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         \textbf{\StrengthLabel} &
                         \textField[
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{ST_Dexterity}{0.6cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{ST_Constitution}{0.6cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{ST_Intelligence}{0.6cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{ST_Wisdom}{0.6cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         \textbf{\WisdomLabel} &
                         \textField[
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{ST_Charisma}{0.6cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         \textbf{\CharismaLabel} &
                         \textField[
        ...
        \begin{tcolorbox}[dndboxgray,
            ...
            \noindent\begin{tabular}{c|l}
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{acrobatics}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{animalHandling}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{arcana}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{athletics}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{stealth}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{investigation}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{deception}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{intimidation}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{performance}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{insight}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{medicine}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{nature}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{perception}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{persuasion}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{sleightOfHand}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{religion}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{survival}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         ...
                         \begin{minipage}{1.5cm}
                             \begin{itemize}
                                 \item\textField[\textColor{myText}\Ff{\FfReadOnly}]{history}{0.5cm}{12pt}
                             \end{itemize}
                         \end{minipage} &
                         \HistoryLabel
            \end{tabular}
...
%Saving throws against death (3 checkboxes per sal)
        ...
        \begin{tcolorbox}[dndbox,
            ...
            \vspace{1ex}
            \\ \textbf{\ProficiencyBonusLabel} \textField[\textColor{myText}\AA{%
                \AACalculate{%
                    calculateSkills();
                }
            }]{ProficiencyBonus}{1cm}{12pt}
            \quad
            \PushButton[name=calculateButton,onclick={calculateSkills();},width=4cm,height=0.8cm]{\faSync\space\UpdateSkillsButtonLabel}
        \end{tcolorbox}
    ...
    \begin{tcolorbox}[dndboxgray,
        ...
        \vspace{1ex}
        \textbf{\AdditionalNotesLabel} \textField[\Ff\FfMultiline\textColor{myText}]{AdditionalNotes}{22.5cm}{3.9cm}
    \end{tcolorbox}
